...
model1 = tf.saved_model.load("saved_model1/")
model2 = tf.saved_model.load("saved_model2/")
model3 = tf.saved_model.load("saved_model3/")
...
for _ in range(args.seeds):
    ...
    if not label1 == label2 == label3:
        ...
        filename = f'./generated_inputs/already_differ_{label1}_{label2}_{label3}.png'
        imageio.imwrite(filename, gen_img_deprocessed)
        continue
    ...
    for iters in range(args.grad_iterations):
        ...
        if not predictions1 == predictions2 == predictions3:
            ...
            filename_gen = f'./generated_inputs/{args.transformation}_{predictions1}_{predictions2}_{predictions3}.png'
            imageio.imwrite(filename_gen, gen_img_deprocessed)

            filename_orig = f'./generated_inputs/{args.transformation}_{predictions1}_{predictions2}_{predictions3}_orig.png'
